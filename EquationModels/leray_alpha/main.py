# DETERMINISTIC
# After python main.py with config.mode="train" in default.py
# Do    python main.py --config=configs/default.py --workdir=. with config.mode="eval"

import os

# Restrict JAX to use only 4 GPUs
